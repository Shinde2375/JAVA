...
public class Test3 {
	...
	public static void main(String[] args) {
		...
		p.add(p4);
		p.add(p5);
		System.out.println(p.add(p5));
		p.add(p5);   //Multiple element not workingg
		p.add(null);
		p.add(null);  // Multiple null not working
		//		p.add(2,p4); >>!notWorking
		p.remove(p3);  // >>workingg
		//		p.clear();   >>working
		...
		System.out.println("4.______Iterator __________");
		//
		Iterator<Product>litf = p.iterator();
		while(litf.hasNext())
		{
			Product t = litf.next();
			System.out.println(t);
		...
		//	System.out.println("3._____Using ListIterator Forward______");
